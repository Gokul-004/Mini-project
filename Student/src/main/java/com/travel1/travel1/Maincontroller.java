...
import com.travel1.travel1.Service.Userserv;
    ...
    @DeleteMapping("/delete/user{id}")
      ...
      private static List<Registrationdetails> details = new ArrayList<Registrationdetails>();
    ...
    @PostMapping
    public Registrationdetails addDetails(@RequestBody Registrationdetails detail) {
        details.add(detail);
        return detail;
    }
